...
class ProgramAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ('match_rules', 'match_candidates', 'match_updated_at')
...
class ProgramCleanupAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ('program', 'evidence', 'rules', 'reference_date', 'created_at', 'updated_at')
...
class ApplicationStatusAdmin(admin.ModelAdmin):
    ...
    list_filter = ('is_synthetic', 'recruitment_year', 'program__sport', 'program__institution__region')
