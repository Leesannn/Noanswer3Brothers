...
class RecommendationTests(TestCase):
    ...
    def add_applications(self, program, rate=95, waiting=True, synthetic=True):
        for month in range(1, 7):
            ApplicationStatus.objects.create(
                ...
                reference_date=date(2026, month, 1), recruitment_year=2026,
    ...
    def test_empty_result_page(self):
        ...
        session.save()
        response = self.client.get(reverse('analytics:licensed_recommendation_results'))
    ...
    def test_recommendation_pages_are_public(self):
        ...
        detail = self.client.get(reverse(
            'analytics:qualification_recommendation_detail', args=[self.sport.pk],
        ))
    ...
    def test_root_redirects_to_recommendation_home(self):
        ...
        self.assertRedirects(
            response, reverse('analytics:recommendation_start'),
            fetch_redirect_response=False,
        )
        home = self.client.get(reverse('analytics:recommendation_start'))
