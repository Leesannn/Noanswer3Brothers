...
from app.management.commands.generate_demo_data import recent_months
from app.models import ApplicationStatus, Institution, Program
...
class DemoDataTests(TestCase):
    ...
    def test_real_data_is_not_deleted(self):
        actual = ApplicationStatus.objects.create(
            ...
            reference_date=recent_months()[0], recruitment_year=recent_months()[0].year,
