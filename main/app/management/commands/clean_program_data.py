...
from app.models import CanonicalSport, Program, ProgramCleanup
from app.services.program_cleanup import ProgramCleaner, cleanup_reference_date
from app.services.sport_matching import matching_key
    ...
    def handle(self, *args, **options):
        ...
        sql = f'''
            INSERT INTO {table}
                (program_id, cleaned_name, matched_sport_id, operating_status,
                 is_usable, exclusion_reason, evidence, rules, reference_date,
        ...
        for program in queryset.iterator(chunk_size=options['batch_size']):
            ...
            pending.append((
                ...
                decision.is_usable, decision.exclusion_reason, decision.evidence,
                json.dumps(decision.rules, ensure_ascii=False), reference_date, now, now,
            ))
