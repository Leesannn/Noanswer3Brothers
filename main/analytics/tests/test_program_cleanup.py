...
from analytics.models import CanonicalSport, Institution, Program, ProgramCleanup, QualificationAggregate
from analytics.services.program_catalog import regional_program_qualification_comparison
from analytics.services.program_cleanup import ProgramCleaner
...
class ProgramCleanupTests(TestCase):
    ...
    def test_incomplete_or_future_date_is_unknown(self):
        ...
        self.assertEqual(future.operating_status, 'upcoming')
