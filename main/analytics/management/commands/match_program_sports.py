...
from analytics.models import CanonicalSport, Program, ProgramMatchPayload, QualificationAggregate
from analytics.services.sport_matching import (
    SportMatcher, match_payload_key, matching_key, sync_taxonomy,
)
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for program in queryset.iterator(chunk_size=options['batch_size']):
            ...
            if payload_key not in payloads and not options['dry_run']:
            ...
            pending.append((
                ...
                result.reason,
                payloads[payload_key].pk if payload_key in payloads else None,
                program.pk,
            ))
